...
class API_RNNAgent(nn.Module):
    ...
    def forward_for_feature(self, inputs, near_n):
        ...
        return embedding, embedding_own, self.unify_input_heads(embedding_enemies), self.unify_input_heads(embedding_allies)
    ...
    def forward(self, inputs, hidden_state):
        ...
        # relation_weight_ally1 = relation_weight_ally[0]
        # ally_feat_t1 = ally_feats_t.reshape(bs*self.n_agents, self.n_allies, -1)[0]
        # relation_weight_ally11 = relation_weight_ally1[:,0,:]
        #
        # relation_weight_enemy1 = relation_weight_enemy[0]
        # reshaped_enemy_feats_t = enemy_feats_t.reshape(bs*self.n_agents, self.n_enemies, -1)
        # enemy_feats_t1 = reshaped_enemy_feats_t[0]
        # relation_weight_enemy11 = relation_weight_enemy1[:, 0, :]
        #
