...
class APIHyperInputLayer(nn.Module):
    def __init__(self, args, output_dim):
        ...
        self.hyper_w_enemy = nn.Sequential(
            # nn.BatchNorm1d(num_features=args.state_enemy_feats_size, momentum=0.01, affine=False),
        ...
        self.hyper_w_ally = nn.Sequential(
            # nn.BatchNorm1d(num_features=args.state_ally_feats_size, momentum=0.01, affine=False),
...
class APIQMixer(nn.Module):
    def __init__(self, args, abs=True):
        ...
        # hyper w1 b1
        self.hyper_w1 = nn.Sequential(w_input_layer,
                                      nn.ReLU(inplace=True),
