...
class HYPER_W1(nn.Module):
    ...
    def forward(self, qvals):
        ...
        :return:
        """
        output = self.hyper_w_ally(qvals.view(-1, 1))   # [b * t * n_agents, output_dim]
        return output
...
class APIQMixer(nn.Module):
    ...
    def forward(self, qvals, states):
        ...
        # First layer
        w1 = self.hyper_w1(qvals).view(-1, self.n_agents, self.embed_dim)  # b * t, n_agents, emb
