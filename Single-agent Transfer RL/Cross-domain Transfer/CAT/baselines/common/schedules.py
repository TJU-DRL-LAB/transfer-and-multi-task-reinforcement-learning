...
class LinearSchedule(object):
    ...
    # 返回的系数随着训练时间逐渐增大的，当fraction为1返回的就是final_p
    def value(self, t):
        """See Schedule.value"""
        fraction = min(float(t) / self.schedule_timesteps, 1.0)
        return self.initial_p + fraction * (self.final_p - self.initial_p)

class NegativeLogSchedule(object):
    def __init__(seelf, schedule_timesteps, final_p, initial_p):
        pass
