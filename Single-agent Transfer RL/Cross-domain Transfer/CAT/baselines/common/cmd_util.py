...
def common_arg_parser():
    ...
    parser.add_argument('--source_env', help='source environment ID', type=str,
                        default=None)
    parser.add_argument('--source_env1', help='source environment1 ID', type=str,
                        default=None)
    ...
    parser.add_argument('--save_filenumber', help='Number of saved reward file', default=0, type=str)
    ...
    parser.add_argument('--teacher_paths1', '--list1', nargs='+',
                        help='Path to teacher1 networks', default=None)
    ...
    parser.add_argument('--ps_coef1', help='coefficient to use for pi dependency loss1',
                        type=float, default=None)
    parser.add_argument('--vf_ps_coef', help='coefficient to use for vf dependency loss',
                        type=float, default=None)
    parser.add_argument('--vf_ps_coef1', help='coefficient to use for vf dependency loss1',
                        type=float, default=None)
    ...
    parser.add_argument('--mutual_info_coef', help='coefficient to use for mutual info',
                        type=float, default=None)
    parser.add_argument('--mutual_info_coef1', help='coefficient to use for mutual info',
                        type=float, default=None)
